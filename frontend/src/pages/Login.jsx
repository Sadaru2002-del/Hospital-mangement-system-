          ...
          <div className="flex-1 w-full max-w-[360px] mx-auto flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                {emailError && (
                  <p className="text-[9px] text-red-500 mt-1">Email is required. Please try again.</p>
                )}
              </div>
              ...
              <div>
                ...
                {passwordError && (
                  <p className="text-[9px] text-red-500 mt-1">Password is required. Please try again.</p>
                )}
              </div>
