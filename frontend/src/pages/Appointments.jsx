  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-400 mt-1">Manage scheduled visits, register check-ins, and assign doctors</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Appointments Table */}
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 lg:col-span-2 shadow-xl">
          <h2 className="text-lg font-bold text-slate-200 mb-6">Upcoming Appointments</h2>
            ...
            <table className="w-full text-left text-sm border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/50">
                {appointments.map((appt) => (
                  <tr key={appt.id} className="text-slate-300 hover:bg-slate-900/50">
                    <td className="py-3.5 font-medium text-slate-200">{appt.patient}</td>
                    <td className="py-3.5">{appt.doctor}</td>
                    <td className="py-3.5">
                      <span className="block text-slate-200">{appt.date}</span>
                      <span className="block text-xs text-slate-400">{appt.time}</span>
                    </td>
                    <td className="py-3.5 text-slate-400">{appt.reason}</td>
                    <td className="py-3.5">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl h-fit">
          <h2 className="text-lg font-bold text-slate-200 mb-6">Schedule Visit</h2>
